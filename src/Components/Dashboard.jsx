...
const Dashboard =()=>{
  ...
  useEffect(() => {
    if (fromDate && toDate) {
      axios
        .get(`${baseURL}/api/orders/report/${merchCode}?start_date=${fromDate}&end_date=${toDate}`)
        .then((response) => {
          console.log(response.data);
  ...
  const totalAmount = report ? report.reduce((sum, item) => sum + item.totalPrice, 0):0;
  const cancelOrders = report ? report.filter((item) => item.isCanceled === true):0;
    ...
    return(
      ...
      <Box sx={{ width: '100%', bgcolor: 'background.paper',display:"flex",alignItems:"center" ,justifyContent:"center"}}>
      <ButtonGroup aria-label="Basic button group">
                <Button
                  variant={value === 0 ? "contained" : "outlined"}
                  style={{
                    backgroundColor:
                      value === 0 ? "#F7C919" : "inherit",
      ...
      <div style={{ display: 'flex',gap: '5%',    flexWrap: 'wrap',alignItems:"center",justifyContent:"center",padding:"5px"}}>
        ...
        <Card className="list" sx={{ minWidth: "20%" }}>
          <CardContent>
            ...
            <Typography variant="h5" component="div"  sx={{ fontSize: 44 }}>
              {SelectCurrency}{totalAmount.toFixed(2)}
            </Typography>
          </CardContent>
          {/* <CardActions>
            <Button size="small">Know More</Button>
    ...
    <div className="item_list">
                ...
                <div style={{display: 'flex',gap: '5%',    flexWrap: 'wrap',alignItems:"center",justifyContent:"center",padding:"5px"}}>
                    <Card className="list">
                        ...
                        <h5  style={{fontSize: "15px",color: "black",lineHeight: "0px"}}>Total Categories</h5>
                    ...
                    <div className="item_logo"></div>
                       <div style={{textAlign:"start"}}>
                       <h5 style={{fontSize: "15px",color: "black",lineHeight: "0px"}}>Total Products</h5>
                    ...
                    {<div className="order_logo"></div>}
                       <div style={{textAlign:"start"}}>
                       <h5 style={{fontSize: "15px",color: "black",lineHeight: "0px"}}>Total Orders</h5>
