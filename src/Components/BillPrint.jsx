...
console.log(props)
  ...
  let address = props.orderDetails ? props.orderDetails.address : getParameterByName("address");
 ...
 let isPrinted = localStorage.getItem('isPrintCall')
    if (props.orderDetails && isPrinted === "N" && !loading ) {
      ...
      printDetails.tax=t({ id: "tax" })+"("+props.orderDetails.taxPerc+"%) " +orderDetails.taxPrice.toFixed(2);
          ...
          {loading ? (
            ...
            >
              <div id="orderDetails" style={{ textAlign: "center" }}>
                <span style={{display:"inline",textAlign:'center',fontSize:'14px'}}>
                Token:</span>
                <h5 style={{ textAlign: "left",margin:"5px",display:'inline'}}>
                   #{orderDetails.number}
                </h5>
                <div
                  style={{
                ...
                <div>
                  <b style={{display:'block',height:"20px",width:'100%',textAlign:'center',margin:'10px',fontSize:'1.2em'}}>{restaurant}</b>
                ...
                >
                  ...
                  <tbody align="left">
                    ...
                    <tr>
                      <td colSpan="2" align="middle">
                      <b> {t({ id: "tax" })}: ({parseFloat(cgst).toFixed(2)}%):</b>
                      </td>
                      <td align="start">
                        {renderCurrencySymbol()} {orderDetails.taxPrice.toFixed(2)}
                      </td>
                    </tr>
                    <tr>
                      <td colSpan="2" align="middle">
              ...
              <p style={{ textAlign: "left",fontSize:"8px",maxWidth:'220px' }}>
